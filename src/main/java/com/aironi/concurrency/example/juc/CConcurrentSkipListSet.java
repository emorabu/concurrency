 ...
 *
 */
public class CConcurrentSkipListSet {
	public static int clientTotal = 5000; // 请求总数
	public static int threadTotal = 200; // 并发线程数
	private static final Logger LOGGER = LoggerFactory.getLogger(CConcurrentSkipListSet.class);
	...
	public static void main(String[] args) throws Exception {
		...
		threadPool.shutdown();
		LOGGER.info("{}",set.size()); // 等于预期值 5000
	}
